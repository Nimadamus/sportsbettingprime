 ...
 * Reads graded picks from Google Sheets and updates the website
 */
...
const RANGE = `${SHEET_NAME}!A2:M1000`; // Read all data rows
...
function parseGradedRows(rows) {
  ...
  for (const row of rows) {
    ...
    // Only include rows that have been graded (W/L/P) and processed
...
module.exports = { fetchSheetData, parseGradedRows, calculateStats };
