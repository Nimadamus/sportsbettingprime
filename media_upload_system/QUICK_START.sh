...
if command -v xdg-open > /dev/null; then
    xdg-open ~/Desktop/select_images.html
elif command -v open > /dev/null; then
    open ~/Desktop/select_images.html
else
    echo "Please open this file in your browser:"
    echo "   ~/Desktop/select_images.html"
fi

echo ""
echo "When you're done selecting, press Enter to continue..."
read
